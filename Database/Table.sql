...
select @pricetransaction = price_transaction from Auction
where id = @id
...
ALTER TRIGGER themdulieuauction
ON Auction_details
FOR INSERT, UPDATE
AS
BEGIN
...
('vanan', 1, '2022-12-20 07:00:00', null, 0, 0, 0, null, 3);
GO

INSERT INTO Auction_details VALUES
(7, 'vanhoa', 15000000, '2022-12-10 09:30:00'),
(7, 'vancao', 13000000, '2022-12-11 09:30:00'),
(7, 'vandat', 12000000, '2022-12-12 07:30:00');
