...
export const getAllAuction = createAsyncThunk(
  "userStore/allauction",
  async () => {
    const res = await axios.get(getAllAuctionUrl(), {
      headers: {
        Authorization: "Bearer " + sessionStorage.getItem("accessToken"),
      },
    });
...
export const getAllProductByCategory = createAsyncThunk(
  "userStore/getAllProductByCategory",
  async (categoryname) => {
    const res = await axios.get(getAllProductByCategoryUrl(categoryname), {
      headers: {
        Authorization: "Bearer " + sessionStorage.getItem("accessToken"),
      },
    });
